...
namespace Project
{
    ...
    {
        private const string Unique = "Project";
        ...
        // This method is executed if you start the Project process from an external application, e.g. a web browser which sends the URL of the file to download
        public bool SignalExternalCommandLineArgs(IList<string> args)
        {
            ...
            {
                // The first argument args[0] contains the path to the Project process
